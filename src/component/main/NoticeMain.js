	...
	const getLocalData = () => {
		const dummyPosts = [
			...
			},
			{
				...
				content:
					'Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur excepturi atque nobis praesentium omnis obcaecati. Sapiente illo nemo doloremque non rem culpa reiciendis modi labore',
			},
			{
				title: 'Signing a contract for the extension of the electrical office building',
				content:
					'Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit architecto nisi quae? Explicabo repudiandae doloremque nisi quae molestias totam, quisquam facilis quam perferendis voluptate',
			},
			{
